...
def spawn_ball(direction):
    ...
    ball_pos = [(WIDTH - 1) / 2.0, (HEIGHT - 1) / 2.0]
...
def new_game():
    ...
    paddle1_pos = ((HEIGHT - 1) / 2) - HALF_PAD_HEIGHT
    paddle2_pos = ((HEIGHT - 1) / 2) - HALF_PAD_HEIGHT
...
def draw(canvas):
    ...
    # collide with and bounces off of the top and bottom walls.
    ...
    canvas.draw_polygon([(WIDTH - PAD_WIDTH, paddle2_pos), (WIDTH - 1, paddle2_pos), (WIDTH - 1, paddle2_pos + PAD_HEIGHT), (WIDTH - PAD_WIDTH, paddle2_pos + PAD_HEIGHT)], 1, 'White', 'White')
    ...
    # draw scores
    canvas.draw_text(str(score1), (WIDTH * 0.25, HEIGHT/4), 30, 'White')
    canvas.draw_text(str(score2), (WIDTH * 0.75, HEIGHT/4), 30, 'White')
